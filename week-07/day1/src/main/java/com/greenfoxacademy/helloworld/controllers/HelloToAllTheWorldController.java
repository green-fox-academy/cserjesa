...
import com.greenfoxacademy.helloworld.models.HelloStyle;
...
public class HelloToAllTheWorldController {
    ...
    @RequestMapping("/web/multiGreeting")

    public String greeting(Model model) {
        List<HelloStyle> helloList = new ArrayList<>();
        for (String helloText : hellos) {
            helloList.add(new HelloStyle(helloText));
        }
